    ...
    <div className="space-y-6 max-w-[1600px] mx-auto">
      ...
      <div>
        <div className="flex items-center gap-2 mb-1">
          ...
          <h1 className="text-2xl font-bold text-text-primary">Engagement Architecture</h1>
        </div>
        <p className="text-text-secondary text-sm max-w-2xl">
          Four-tier engagement model that guides organisations from initial exploration to deep ecosystem integration.
          Each tier offers progressively richer access, resources, and co-innovation opportunities.
        </p>
      </div>
              ...
              <div className="p-5">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <span className="text-2xl font-bold" style={{ color: tier.color }}>{tier.count}</span>
                    <span className="text-[10px] text-text-secondary ml-1">orgs</span>
                  </div>
                </div>
                ...
                <div className="space-y-3 text-xs">
                  ...
                  <div className="flex items-start gap-2">
                    <Star className="w-3.5 h-3.5 text-text-secondary mt-0.5 shrink-0" />
                    <div>
                      <span className="text-text-secondary">Access: </span>
                      <span className="text-text-primary">{tier.access}</span>
                    </div>
                  </div>
                </div>
